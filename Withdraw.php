<?php
    ...
    if(isset($_POST['cardNumber']) && isset($_POST['cvv']) && isset($_POST['Expirationday'])){
        ...
        $result = WithdrawMoney($cardNumber, $amount, $cvv, $Expirationday);
        if (empty($cardNumber)) {
...
body{
    background-image: url('images/Withdraw.jpeg');
...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-6 col-lg-5">
            <h3 class="t1" class="text-center text-secondary mt-5 mb-3">Withdraw Money</h3>

            <form method="post" action="" class="border rounded w-100 mb-5 mx-auto px-3 pt-3 bg-light">
                <div class="form-group">
                <span><i class="fa fa-credit-card" aria-hidden="true"></i></span>
                    <label>CardNumber</label>
                    <input value="" name="cardNumber" id="cardNumber" type="number" class="form-control">
                </div>
                <div class="form-group">
                <span><i class="fa fa-credit-card-alt" aria-hidden="true"></i></span>

                    <label>CVV</label>
                    <input value="" name="cvv" id="cvv" type="number" class="form-control">
                </div>
                <div class="form-group">
